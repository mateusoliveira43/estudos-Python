...
class Box(BoxStructure):
    ...
    def print_content(self, contador=0) -> None:
        tab = '    '
        print(f'{tab*contador}{self.name}:')
        contador += 1
        for child in self._children:
            child.print_content(contador)
...
class Product(BoxStructure):
    ...
    def print_content(self, contador=False) -> None:
        tab = '    '
        print(f'{tab*contador}{self.name} {self.price}')
